...
def reset_alarm(**kwargs):
    """
    Resets an alarm on a given HostSystem in a vmware_vsphere to the green state
    ...
    http://www.virtuallyghetto.com/2010/10/how-to-ack-reset-vsphere-alarm.html
...
def _build_payload(**kwargs):
    """
    Builds a SOAP envelope to send to the vmware_vsphere hidden API
...
def _send_request(payload=None, session=None):
    ...
    vmware_vsphere API to reset an alarm to the green state.
