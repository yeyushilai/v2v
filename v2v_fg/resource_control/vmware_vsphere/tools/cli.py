...
class Parser:
    ...
    def __init__(self):
        ...
        """
        self._parser = argparse.ArgumentParser(description='Arguments for talking to vmware_vsphere')
...
class Argument:
    ...
    LANGUAGE = {
        ...
        'options': {'action': 'store', 'default': 'English', 'help': 'Language your vmware_vsphere used.'}
    }
    VIHOST = {
        'name_or_flags': ['--vihost'],
        'options': {'action': 'store',
                    'help': 'Name/ip address of ESXi host as seen in vmware_vsphere Server'}
    }
    DVS_PORT_GROUP_NAME = {
